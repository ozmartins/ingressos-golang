// Package health separa "o processo está no ar" de "o serviço é capaz de
// processar cobranças" (FR-025). A distinção importa: um serviço vivo que não
// alcança o banco não deve receber tráfego, mas também não deve ser reiniciado.
package health
