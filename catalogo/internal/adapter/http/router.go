...
var rotas = []Rota{
	...
	{Metodo: "POST", Caminho: "/api/v1/cinemas/{id}/salas", Documentada: true, Protegida: true,
		handler: simples(func(d Dependencias) http.HandlerFunc { return d.Handlers.PostSala })},
	{Metodo: "GET", Caminho: "/api/v1/cinemas/{id}/salas/{sala_id}", Documentada: true,
		handler: simples(func(d Dependencias) http.HandlerFunc { return d.Handlers.GetSala })},
	{Metodo: "PUT", Caminho: "/api/v1/cinemas/{id}/salas/{sala_id}", Documentada: true, Protegida: true,
		handler: simples(func(d Dependencias) http.HandlerFunc { return d.Handlers.PutSala })},
	{Metodo: "DELETE", Caminho: "/api/v1/cinemas/{id}/salas/{sala_id}", Documentada: true, Protegida: true,
