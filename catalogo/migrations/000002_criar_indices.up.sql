...
CREATE INDEX idx_filmes_titulo_id ON filmes (titulo, id);
CREATE INDEX idx_cinemas_nome_id ON cinemas (nome, id);
CREATE INDEX idx_salas_cinema_numero_id ON salas (cinema_id, numero, id);
CREATE INDEX idx_sessoes_inicio_id ON sessoes (data_hora_inicio, id);
...
CREATE INDEX idx_sessoes_status_inicio ON sessoes (status, data_hora_inicio);
CREATE INDEX idx_sessoes_filme_inicio ON sessoes (filme_id, data_hora_inicio);
CREATE INDEX idx_sessoes_sala ON sessoes (sala_id);
